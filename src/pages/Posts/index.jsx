      ...
      <div className="posts">
        ...
        <ul className="posts__list">
          <li className="posts__item">
            ...
            <p className="posts__description">Присоединяйтесь к нам в путешествии по красивым горам Японии.</p>
          </li>
          <li className="posts__item">
            <img
              className="posts__image"
            ...
            <p className="posts__description">Исследуйте уникальную красоту Сахары в Марокко.</p>
          </li>
          <li className="posts__item">
            <img
              className="posts__image"
            ...
            <p className="posts__description">Отдохните на прекрасных пляжах Карибских островов.</p>
          </li>
        </ul>
      </div>
    </>
